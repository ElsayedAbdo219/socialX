...
class PurshaseSupplierRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'ton_quantity_cutting'=>['required','numeric'],
            ...
            'first_amount'=>['nullable','numeric','required_if:payment_way,'.PaymentTypeEnum::INSTALLMENT],
            'duration'=>['nullable','numeric','required_if:payment_way,'.PaymentTypeEnum::INSTALLMENT],
