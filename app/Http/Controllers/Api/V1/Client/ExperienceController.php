...
class ExperienceController extends Controller
{
  ...
  public function add(Request $request)
  {
    ...
    $data = $request->validate([
      ...
      'company_id' => 'nullable|integer|exists:members,id,type,' . UserTypeEnum::COMPANY . '|required_without:custom_company_name',
      'custom_company_name' => 'nullable|string|max:255|required_without:company_id',
