...
class PaymobController extends Controller
{
    ...
    public function credit() {
        ...
        return Redirect::away('https://accept.paymob.com/api/acceptance/iframes/'.'755836'.'?payment_token='.$paymentToken);
    }
    ...
    public function createOrder($tokens) {
        //this functio n takes last step token and send new order to paymob dashboard
   ...
   $secret = "EDCF939BD1AB32679EAFBC0AC0C951F6";
