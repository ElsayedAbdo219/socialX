...
class PurchasingFromSupplierDatatable extends BaseDatatable  {
    ...
    public function query(): Builder
    {
        return purchasing::query(
            )->OfType(UserTypeEnum::SUPPLIER)->with(['user','trader'])->when(request('search')['value'], function ($q) {
