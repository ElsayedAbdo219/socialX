            ...
            <div class="col-12 mt-3">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="POST" action="{{ route('admin.sectoral-selling.update', $SectoralSelling->id) }}">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-3">
                                        ...
                                        <select class="form-control" name="payment_type" id="payment_type"
                                            onchange="toggleInputPaymentSectoral()" value="{{ $SectoralSelling->payment_type }}">
                                    ...
                                    <div class="form-group col-sm-3"  style="display: none" id="payment_amout" >
                                        <label for="name_en">{{ __('dashboard.payment_amout') }}
                                            <input type="number" class="form-control" name="payment_amout"
                                                placeholder="{{ __('dashboard.payment_amout') }}" value="{{ $SectoralSelling->payment_amout }}" />
                                            @error('payment_amout')
                                                <span style="font-size: 12px;" class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </label>
                                    ...
                                    <div class="form-group col-sm-3">
                                        ...
                                        <select class="form-control" name="unit" id="unit" value="{{ $SectoralSelling->unit }}">
                                    ...
                                    <div class="form-group col-sm-3">
                                        <label for="name_en">{{ __('dashboard.quantity') }}
                                            <input type="number" class="form-control" name="quantity"
                                                placeholder="{{ __('dashboard.quantity') }}" value="{{ $SectoralSelling->quantity }}" />
                                            @error('quantity')
                                                <span style="font-size: 12px;" class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </label>
                                    ...
                                    <div class="form-group col-sm-3">
                                        <label for="name_en">{{ __('dashboard.unit_price') }}
                                            <input type="number" class="form-control" name="unit_price"
                                                placeholder="{{ __('dashboard.unit_price') }}" value="{{ $SectoralSelling->unit_price }}" />
                                            @error('unit_price')
                                                <span style="font-size: 12px;" class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </label>
