...
@section('title')
    {{ __('dashboard.add_purshasing_from_supplier') }}
@endsection
<!-- BEGIN: Content-->
@section('content')
    @if (session('success'))
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <x-dashboard.layouts.breadcrumb now="{{ __('dashboard.add_purshasing_from_supplier') }}">
                <li class="breadcrumb-item"><a href="{{ route('admin.purshasefromsuppliers.index') }}">
                        {{ __('dashboard.add_purshasing_from_supplier') }}
                    </a></li>
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('dashboard.add_purshasing_from_supplier') }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="POST" action="{{ route('admin.purshasefromsuppliers.store') }}">
                                @csrf
                                <div class="row">
