    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <x-dashboard.layouts.breadcrumb now="{{__('dashboard.companies')}}">
                <li class="breadcrumb-item"><a href="{{route('admin.traders.companies.index')}}">
                        {{__('dashboard.companies')}}
                    </a></li>
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('dashboard.add_company')}}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="POST" action="{{route('admin.traders.companies.store')}}" >
                                @csrf
                              <div class="row">
