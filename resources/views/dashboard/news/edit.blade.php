                            ...
                            <form class="form form-vertical" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-4">
                                        <label class="w-100" for="is_poll">{{ __('dashboard.is_poll') }}</label><br>

                                        <label>
                                            <input type="radio" name="is_poll" value="1"
                                                {{ $News->is_poll == 1 ? 'checked' : '' }}>
                                            @lang('dashboard.yes')
                                        </label><br>

                                        <label>
                                            <input type="radio" name="is_poll" value="0"
                                                {{ $News->is_poll == 0 ? 'checked' : '' }}>
                                            @lang('dashboard.no')
                                        </label>
