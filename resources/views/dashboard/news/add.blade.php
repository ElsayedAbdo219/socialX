              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="title" placeholder="العنوان"
                      style="height:100px;">{{ old('title') }}</textarea>
                    @error('title')
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="contentNews" placeholder="المحتوي"
                      style="height:150px;">{{ old('contentNews') }}</textarea>
                    @error('contentNews')
                    <span style="font-size: 12px;" class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" dir="ltr" name="title_en" placeholder="العنوان بالإنجليزية"
                      style="height:100px;">{{ old('title_en') }}</textarea>
                    @error('title_en')
                    <span style="font-size: 12px;" class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" dir="ltr" name="contentNews_en" placeholder="المحتوي بالإنجليزية"
                      style="height:150px;">{{ old('contentNews_en') }}</textarea>
                ...
                <div class="row" style="width: 100%; margin: 0; padding: 0;">
                  <div class="col-6">
                  <div class="form-group">
                    <select class="form-select countries_status"  id="countries_status" name="countries_status" aria-label="Define Countries Status">
                   ...
                   <div class="col-6 ">
                  <div class="form-group" >
                    <select class="form-select countries"  style="display: none; padding:15px"
                     id="countries" name="countries[]"  aria-label="select Countries" multiple>
