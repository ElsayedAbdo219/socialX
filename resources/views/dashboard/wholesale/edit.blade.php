            ...
            <div class="col-12 mt-3">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="POST" action="{{ route('admin.WholeSale.update', $wholesale->id) }}">
                                @csrf
                               @method('PATCH')
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-3">
                                        <label for="name_en">{{ __('dashboard.ton_quantity') }}
                                            <input type="number" class="form-control" name="ton_quantity"
                                                placeholder="{{ __('dashboard.ton_quantity') }}"  value="{{ $wholesale->ton_quantity }}"/>
                                            @error('ton_quantity')
                                                <span style="font-size: 12px;" class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </label>
                                    ...
                                    <div class="form-group col-sm-3">
                                        <label for="name_en">{{ __('dashboard.ton_quantity_price') }}
                                            <input type="number" class="form-control" name="ton_quantity_price"
                                                placeholder="{{ __('dashboard.ton_quantity_price') }}" value="{{ $wholesale->ton_quantity_price }}" />
                                    ...
                                    <div class="form-group col-sm-3" >
                                        ...
                                        <select class="form-control" name="delivery_way"  onchange="toggleInputDelivery()" id="delivery_way" value="{{ $wholesale->delivery_way }}" >
                                    ...
                                    <div class="form-group col-sm-3" style="display: none;"  id="ton_nolon_price" >
                                        <label for="name_en">{{ __('dashboard.ton_nolon_price') }}
                                            <input type="number" class="form-control" name="ton_nolon_price"
                                                placeholder="{{ __('dashboard.ton_nolon_price') }}" value="{{ $wholesale->ton_nolon_price }}"/>
                                    ...
                                    <div class="form-group col-sm-3">
                                        <label for="name_en">{{ __('dashboard.deposit_money') }}
                                            <input type="number" class="form-control" name="deposit_money"
                                                placeholder="{{ __('dashboard.deposit_money') }}" value="{{ $wholesale->deposit_money }}"  />
                                            @error('deposit_money')
                                                <span style="font-size: 12px;" class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </label>
                                    ...
                                    <div class="form-group col-sm-3">
                                        ...
                                        <select class="form-control" name="payment_type" id="payment_type"
                                            onchange="toggleInputPayment()" value="{{ $wholesale->payment_type }}">
                                    ...
                                    <div class="form-group col-sm-3" style="display: none;" id="first_amount">
                                        <label for="name_en">{{ __('dashboard.first_amount') }}
                                            <input type="number" class="form-control" name="first_amount"
                                                placeholder="{{ __('dashboard.first_amount') }}" value="{{ $wholesale->first_amount }}"  />
                                            @error('first_amount')
                                                <span style="font-size: 12px;" class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </label>
                                    </div>
                                    <div class="form-group col-sm-3" style="display: none;" id="duration" value="{{ $wholesale->duration }}" >
