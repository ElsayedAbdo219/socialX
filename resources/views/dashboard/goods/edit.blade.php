...
@section('content')
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <x-dashboard.layouts.breadcrumb now="{{$goodType->name}}">
                <li class="breadcrumb-item"><a href="{{route('admin.goods-types.index')}}">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="POST" action="{{route('admin.goods-types.update',$goodType->id)}}" >
                                @csrf
                                @method('PATCH')
                               <div class="row">
                                    <div class="form-group col-sm-3">
                                        <label for="name_en">{{__('dashboard.name')}}
                                            <input type="text"  class="form-control" name="name" placeholder="{{__('dashboard.name')}}" value="{{$goodType->name ?? old('name')}}" />
                                            @error('name')
