                ...
                <ul class="menu-content" style="background: none;">
                    ...
                    <li class="{{ Route::is('admin.jobs.index') ? 'active' : '' }}">
                        <a href="{{ route('admin.jobs.index') }}">
                            <i class="feather icon-eye"></i>
                            <span class="menu-item" data-i18n="List View">{{ __('dashboard.show_jobs') }}</span>
                        </a>
                    </li>
                ...
                <ul class="menu-content" style="background: none;">
                    ...
                    <li class="{{ Route::is('admin.companies.index') ? 'active' : '' }}">
                        <a href="{{ route('admin.companies.index') }}">
                            <i class="feather icon-eye"></i>
                            <span class="menu-item" data-i18n="List View">{{ __('dashboard.show_companies') }}</span>
                        </a>
                    </li>
                ...
                <ul class="menu-content" style="background: none;">
                    ...
                    <li class="{{ Route::is('admin.sponsers.index') ? 'active' : '' }}">
                        <a href="{{ route('admin.sponsers.index') }}">
                            <i class="feather icon-eye"></i>
                            <span class="menu-item" data-i18n="List View">{{ __('dashboard.show_sponsers') }}</span>
                        </a>
                    </li>
                    ...
                    <li class="{{ Route::is('admin.categories.index') ? 'active' : '' }}">
                        <a href="{{ route('admin.categories.index') }}">
                            ...
                            <span class="menu-item"
                                data-i18n="List View">{{ __('dashboard.show_categories') }}</span>
                        </a>
                    </li>
