        ...
        <div class="navbar-container content">
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    @endif
                    {{-- <img src="{{ asset('storage/icons/Vector_anceega_ar.png') }}" alt="img icon anceega" srcset=""> --}}
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            {{-- <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ auth()->user()?->name }}</span><span class="user-status">
                                {{ optional(auth()->user())?->name}}</span></div><span> --}}
                                    ...
                                    @if(app()->getLocale() == "ar")
                              <img src="{{ asset('storage/icons/Vector_anceega_ar.png') }}" 
                              alt="" srcset="" style="width:60px;color:white;">
                              @else
                              <img src="{{ asset('storage/icons/Vector_anceega_en.png') }}" 
                              alt="" srcset="" style="width:60px;color:white;">
                              @endif
