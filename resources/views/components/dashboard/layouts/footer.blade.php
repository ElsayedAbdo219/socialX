...
<footer class="footer footer-static footer-light">
    <p class="clearfix blue-grey lighten-2 mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2025<a
                class="text-bold-800 grey darken-2" href="#" target="_blank">AnCeega,</a>All rights Reserved</span><span
 ...
 */
    ...
    function toggleInputPayment() {
        ...
        //البيع قطاعي
        function toggleInputPaymentSectoral() {

            var paymentTypeSelect = document.getElementById("payment_type");
            var traderInput = document.getElementById("trader");
            var phoneInput = document.getElementById("phone");
            var paymentAmountInput = document.getElementById("payment_amout");

            if (paymentTypeSelect.value === "checking_account") {
                
                traderInput.style.display = "block";
                ...
                traderInput.style.display = "none";
